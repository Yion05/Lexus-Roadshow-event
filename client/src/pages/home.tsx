...
const RegistrationForm: React.FC = () => {
  ...
  const formContainerClasses = `
        w-full max-w-3xl text-left text-gray-800 bg-white/95 rounded-2xl shadow-2xl p-8 my-24
        transition-all duration-500 ease-in-out z-20 relative
        shadow-2xl
        ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}
    `;

  const inputClasses = (name: keyof FormErrors) =>
    `w-full p-3.5 border-2 rounded-lg text-base transition-colors focus:outline-none focus:border-black ${
      ...
      <div className={formContainerClasses}>
        ...
        <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="flex flex-col gap-x-6 gap-y-5">
              ...
              <div className="form-group">
                ...
                >
                  ...
                  <option value="2500-5000">RM2,501 - RM5,000</option>
                  <option value="5000-7500">RM5,001 - RM7,500</option>
                  <option value="7500-10000">RM7,501 - RM10,000</option>
                  <option value="10000-15000">RM10,001 - RM15,000</option>
                  <option value="15000-20000">RM15,001 - RM20,000</option>
                  <option value="over-20000">Over RM20,001</option>
                </select>
              ...
              <div className="md:col-span-2">
                ...
                <div className="relative mt-2">
                  <label
                    ...
                    className="flex items-center justify-center w-full px-4 py-3 text-gray-700 bg-gray-100 border-2 border-black border-dashed rounded-lg cursor-pointer hover:bg-gray-200"
                  >
          ...
          <div className="mb-6 pb-4 border-b border-gray-200">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 w-full mt-2">
              <button
                ...
                className="w-full md:w-auto px-6 py-3 text-white bg-black rounded-lg font-semibold transition-opacity disabled:bg-gray-400 disabled:cursor-not-allowed"
              >
          ...
          <button
            ...
            className="w-full p-4 text-lg font-semibold text-white bg-black rounded-lg cursor-pointer transition-all hover:bg-gray-800 hover:scale-105 disabled:bg-gray-500 disabled:cursor-not-allowed disabled:opacity-60"
          >
            Submit Registration
          </button>
