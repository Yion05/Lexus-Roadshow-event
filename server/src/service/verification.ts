...
export class OTP_Class {
    async otpCall(mobile_num: string) {
        ...
        try {
            ...
            const query = `
                        INSERT INTO otp_verifications (contact_number, otp_hash, expires_at, is_verified)
                        VALUES ($1, $2, $3, $4) ON CONFLICT (contact_number) DO UPDATE SET
    ...
    async checkOTPExist(mobile_num: string) {
